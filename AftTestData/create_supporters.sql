...
CREATE TABLE [dbo].[Supporters](
	...
	[CustomBoolean0] [bit] NOT NULL,
	[CustomBoolean1] [bit] NOT NULL,
	[CustomBoolean2] [bit] NOT NULL,
	[CustomBoolean3] [bit] NOT NULL,
	[CustomBoolean4] [bit] NOT NULL,
	[CustomBoolean5] [bit] NOT NULL,
	[CustomBoolean6] [bit] NOT NULL,
